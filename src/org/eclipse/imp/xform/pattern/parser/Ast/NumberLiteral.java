...
/**
 *<b>
 *<li>Rule 48:  NumberLiteral ::= NUMBER$valueStr
 *</b>
 */
public class NumberLiteral extends PatternNodeToken implements INumberLiteral
{
    ...
    public NumberLiteral(ASTPatternParser environment, IToken token)    {
        super(token);
